...
#ifndef TESTS_GEOBASE_HELPER_FAIRGEOSET_H
#define TESTS_GEOBASE_HELPER_FAIRGEOSET_H

namespace fairroot::tests
{

auto checkGeoSetNamingConventions(FairGeoSet& geo, const std::string& prefix)
{
